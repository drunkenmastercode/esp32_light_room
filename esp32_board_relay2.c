...
String processor(const String& var){
  if(var == "BUTTONPLACEHOLDER"){
    String buttons ="";
      ...
      buttons += "<h4>Светильник 2 </h4><label class=\"switch\"><input type=\"checkbox\" onchange=\"toggleCheckbox(this)\" id=\"1\" " + outputState(2) + "><span class=\"slider\"></span></label>";
      buttons += "<h4>Светильник 3 </h4><label class=\"switch\"><input type=\"checkbox\" onchange=\"toggleCheckbox(this)\" id=\"2\" " + outputState(4) + "><span class=\"slider\"></span></label>";
      buttons += "<h4>Светильник 4 </h4><label class=\"switch\"><input type=\"checkbox\" onchange=\"toggleCheckbox(this)\" id=\"3\" " + outputState(6) + "><span class=\"slider\"></span></label>";
    ...
    if (EspDataMsg.idMsg == CMD) {
      switch (EspDataMsg.idLight) {
        case 0:
          ...
          break;
        case 1:
          digitalWrite(relayGPIOs[1], EspDataMsg.DataMsg);     // переводим "GPIO" вывод в соответсвующее состояние 
          break;
        case 2:
          digitalWrite(relayGPIOs[2], EspDataMsg.DataMsg);     // переводим "GPIO" вывод в соответсвующее состояние 
          break;
        case 3:
          digitalWrite(relayGPIOs[3], EspDataMsg.DataMsg);     // переводим "GPIO" вывод в соответсвующее состояние 
          break;
        case 4:
          digitalWrite(relayGPIOs[4], EspDataMsg.DataMsg);     // переводим "GPIO" вывод в соответсвующее состояние           
          break;
        case 5:
          digitalWrite(relayGPIOs[5], EspDataMsg.DataMsg);     // переводим "GPIO" вывод в соответсвующее состояние 
          break;
        case 6:
          digitalWrite(relayGPIOs[6], EspDataMsg.DataMsg);     // переводим "GPIO" вывод в соответсвующее состояние 
          break;
        case 7:
          digitalWrite(relayGPIOs[7], EspDataMsg.DataMsg);     // переводим "GPIO" вывод в соответсвующее состояние 
          break;
        default:
          break;
      }    
